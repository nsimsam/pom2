...
<footer>
Grown by Noor &#127793; &middot; <a href="https://github.com/nsimsam/pom2-portal" target="_blank" rel="noopener noreferrer">Source on GitHub</a>
</footer>
...
def main():
    tq, tw, tl = totals()
    html = TEMPLATE.format(fonts=FONTS, cf=CF, cards=cards(), pillnav=PILLNAV)
